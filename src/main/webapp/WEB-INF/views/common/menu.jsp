...
<ul class="nav flex-column">
   ...
   <li class="nav-item mb-2">
      ...
      <a class="text-white" href="${pageContext.request.contextPath}/ch12/content">View/Bean Name View Resolver</a>
   	  </h6>
   </li>
   <li class="nav-item mb-2">
      <h6 class="text-white"> 
   ...
   <li class="nav-item mb-2">
      <h6 class="text-white"> 
      <span class="mr-2">Ch18.</span>
      <a class="text-white" href="${pageContext.request.contextPath}/ch18/content">ExecutorService</a>
   	  </h6>
   </li>   
</ul>